...
public static class SkinNames
{
    ...
    public static readonly string Cactus = "Kaktus";
    public static readonly string Cat = "Katze";
    public static readonly string Snowman = "Schneemann";
    public static readonly string Owl = "Eule";
}